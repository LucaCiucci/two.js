...
export class RadialGradient extends Gradient {
    ...
    clone(parent) {
        ...
        const clone = new RadialGradient(this.center._x, this.center._y, this._radius, stops, this.focal._x, this.focal._y);
