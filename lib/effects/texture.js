...
export class Texture extends Element {
    constructor(src, callback) {
        ...
        if (typeof src === 'string') {
            ...
            if (elemString === '[object HTMLImageElement]' ||
 ...
 */
Texture.RegularExpressions = regex;
/**
 ...
 */
Texture.ImageRegistry = new Registry();
/**
 * @name Two.Register
 * @interface
