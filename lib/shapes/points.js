...
import { Path, FlagVertices, BindVertices, UnbindVertices, FlagFill, FlagStroke } from '../path.js';
...
export class Points extends Shape {
    constructor(vertices) {
         ...
         */
        this.getBoundingClientRect = Path.prototype.getBoundingClientRect;
        /**
         ...
         */
        this._updateLength = Path.prototype._updateLength;
