 ...
 */
Two.AutoCalculateImportedMatrices = Constants.AutoCalculateImportedMatrices;
/**
 * @name Two.Instances
 * @property {Two[]} - Registered list of all Two.js instances in the current session.
 */
Two.Instances = Constants.Instances;
/**
 ...
 */
Two.uniqueId = Constants.uniqueId;
Two.Anchor = Anchor;
